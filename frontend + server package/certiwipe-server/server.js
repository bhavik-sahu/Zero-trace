...
const { authenticateToken, verifyFirebaseToken } = require('./middleware/auth.middleware');
const geminiChat = require('./services/geminiChat');
...
// Authentication middleware is now imported from './middleware/auth.middleware.js'
